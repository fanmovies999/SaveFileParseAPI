...
app.MapPost("/api/v1/RawDatabaseImage", async (Stream body) =>
{
...
// app.MapPost("/api/v1/RawExclusiveImage", async (Stream body) =>
// {
//     if (body == null) return Results.UnprocessableEntity("Invalid file");
...
//     // Step 2: Extract RawExclusiveImage
//     if (!saveData.Root.Fields.ContainsKey("RawExclusiveImage"))
//         return Results.UnprocessableEntity("Not a Hogwarts Legacy save file");

//     var db = saveData.Root.Fields["RawExclusiveImage"] as FArrayProperty;
//     var dbBytes = (byte[])db.AsPrimitive();
...
//     {
//         // Decompress the archive
//         var Ar = new FArchiveLoadCompressedProxy("RawExclusiveImage", dbBytes, "Oodle");
//         dbBytes = Ar.ReadArray<byte>();
